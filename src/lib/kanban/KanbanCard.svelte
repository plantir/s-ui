<script lang="ts">
	...
	import type { KanbanCardProps } from '$lib/types.js';
	import { kanbanCard } from './theme.js';
...
## Type
[KanbanCardProps](https://github.com/themesberg/s-ui/blob/main/src/lib/types.ts#L2230)
## Props
@prop card
