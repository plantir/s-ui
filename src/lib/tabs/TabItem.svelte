<script lang="ts">
	import type { SelectedTab, TabCtxType, TabitemProps } from '$lib/types.js';
	import { getTheme } from '$lib/theme/themeUtils';
	import { useSingleSelection } from '$lib/utils/singleselection.svelte';
	import clsx from 'clsx';
	import { tabItem, tabs } from './theme.js';
	...
	const updateSingleSelection = useSingleSelection<SelectedTab>(
		(value) => (open = value?.id === self.id)
	);
