<script lang="ts">
	...
	import {
		...
		useSingleSelection
	} from '$lib/utils/singleselection.svelte';
...
<div
	id={panelId}
	class={content({ class: clsx(theme?.content, styling.content) })}
	role="tabpanel"
...
## Type
[TabsProps](https://github.com/themesberg/s-ui/blob/main/src/lib/types.ts#L1854)
## Props
@prop children
