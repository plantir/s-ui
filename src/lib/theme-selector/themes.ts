...
import fluentCss from './themes/fluent-runtime.css?url';

export type ThemeId = 'default' | 'minimal' | 'enterprise' | 'playful' | 'mono' | 'fluent';
...
export const themeConfigs = [
	...
	},
	{
		...
		fontUrl:
			'https://fonts.googleapis.com/css2?family=STIX+Two+Text:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500;1,600;1,700&display=swap',
		colors: [
			'bg-zinc-100 dark:bg-zinc-700',
			'bg-cyan-50 dark:bg-cyan-900',
			'bg-cyan-100 dark:bg-cyan-800',
			'bg-cyan-700 dark:bg-cyan-700'
		]
	},
	{
		id: 'playful',
	...
	},
	{
		...
		cssPath: monoCss,
		fontUrl:
			'https://fonts.googleapis.com/css2?family=Google+Sans+Code:wght@300;400;500;600;700&display=swap',
		colors: [
