...
export type ProgressStepperVariants = VariantProps<typeof progressStepper>;
export type DetailedStepperVariants = VariantProps<typeof detailedStepper>;
export type VerticalStepperVariants = VariantProps<typeof verticalStepper>;
export type BreadcrumbStepperVariants = VariantProps<typeof breadcrumbStepper>;
export type TimelineStepperVariants = VariantProps<typeof timelineStepper>;
