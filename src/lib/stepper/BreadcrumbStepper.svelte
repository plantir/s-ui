<script lang="ts">
	...
	import { breadcrumbStepper } from './theme.js';
	import clsx from 'clsx';
	import type { BreadcrumbStepperProps } from '$lib/types.js';
...
## Type
[BreadcrumbStepperProps](https://github.com/themesberg/s-ui/blob/main/src/lib/types.ts#L1729)
## Props
@prop steps = []
