<script lang="ts">
	...
	import { detailedStepper } from './theme.js';
	import type { DetailedStepperProps } from '$lib/types.js';
...
## Type
[DetailedStepperProps](https://github.com/themesberg/s-ui/blob/main/src/lib/types.ts#L1692)
## Props
@prop steps = []
@prop contentClass
