<script lang="ts" generics="T">
	import type { VirtualMasonryProps } from '$lib/types.js';
	import { virtualMasonry } from './theme.js';
...
## Type
[VirtualMasonryProps](https://github.com/themesberg/s-ui/blob/main/src/lib/types.ts)
## Props
@prop items = []
@prop columns = 3
@prop gap = 16
