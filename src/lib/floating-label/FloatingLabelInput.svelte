<script lang="ts">
	...
	import { floatingLabelInput } from './theme.js';
	import clsx from 'clsx';
	import type { FloatingLabelInputProps } from '$lib/types.js';
...
## Type
[FloatingLabelInputProps](https://github.com/themesberg/s-ui/blob/main/src/lib/types.ts#L825)
## Props
@prop children
@prop id = idGenerator()
@prop value = $bindable()
