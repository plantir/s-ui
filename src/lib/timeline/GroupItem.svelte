<script lang="ts">
	import { groupItem } from './theme.js';
	import type { GroupItemProps } from '$lib/types.js';
...
## Type
[GroupItemProps](https://github.com/themesberg/s-ui/blob/main/src/lib/types.ts#L1932)
## Props
@prop timelines
@prop aClass
@prop imgClass
