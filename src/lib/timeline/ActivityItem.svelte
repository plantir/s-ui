<script lang="ts">
	import { activityItem } from './theme.js';
	import type { ActivityItemProps } from '$lib/types.js';
...
## Type
[ActivityItemProps](https://github.com/themesberg/s-ui/blob/main/src/lib/types.ts#L1912)
## Props
@prop activities
@prop liClass
@prop spanClass
