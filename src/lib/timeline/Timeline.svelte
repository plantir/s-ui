<script lang="ts">
	...
	import { timeline, type TimelineVariants } from './theme.js';
	import clsx from 'clsx';
	import type { TimelineProps } from '$lib/types.js';
...
## Type
[TimelineProps](https://github.com/themesberg/s-ui/blob/main/src/lib/types.ts#L1953)
## Props
@prop children
@prop order = "default"
