<script lang="ts">
	import { scrollspy } from './theme.js';
	import type { ScrollSpyProps } from '$lib/types.js';
...
## Type
[ScrollSpyProps](https://github.com/themesberg/s-ui/blob/main/src/lib/types.ts#L2328)
## Props
@prop items
@prop position = "top"
@prop offset = 0
