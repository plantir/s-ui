<script lang="ts">
	...
	import type { ListgroupItemProps } from '$lib/types.js';
	import { listGroupItem, type ListgroupItemVariants } from './theme.js';
	...
	let state: ListgroupItemVariants['state'] = $derived(
		disabled ? 'disabled' : current ? 'current' : 'normal'
	);
...
## Type
[ListgroupItemProps](https://github.com/themesberg/s-ui/blob/main/src/lib/types.ts#L1140)
## Props
@prop children
@prop active
@prop current
