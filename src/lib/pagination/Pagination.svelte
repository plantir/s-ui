<script lang="ts">
	import { pagination } from './theme.js';
	import PaginationItem from './PaginationItem.svelte';
	import type { PaginationProps, PaginationContextType } from '$lib/types.js';
...
## Type
[PaginationProps](https://github.com/themesberg/s-ui/blob/main/src/lib/types.ts#L1296)
## Props
@prop pages = []
@prop previous
@prop next
