<script lang="ts">
	...
	import { paginationButton } from './theme.js';
	import type { PaginationButtonProps } from '$lib/types.js';
...
## Type
[PaginationButtonProps](https://github.com/themesberg/s-ui/blob/main/src/lib/types.ts#L1260)
## Props
@prop children
@prop size
@prop onclick
