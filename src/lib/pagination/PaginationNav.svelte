<script lang="ts">
	...
	import { paginationNav } from './theme.js';
	import type { PaginationNavProps, PaginationContextType } from '$lib/types.js';
	...
	const styling = $derived(
		classes ?? { prev: prevClass, next: nextClass, span: spanClass, tableDiv: tableDivClass }
	);
...
## Type
[PaginationNavProps](https://github.com/themesberg/s-ui/blob/main/src/lib/types.ts#L1266)
## Props
@prop currentPage = 1
@prop totalPages = 1
@prop visiblePages = 5
