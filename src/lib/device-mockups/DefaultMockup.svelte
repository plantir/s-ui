<script lang="ts">
	import type { DefaultMockupProps } from '$lib/types.js';
	import { warnThemeDeprecation } from '$lib/theme/themeUtils';
	import clsx from 'clsx';
	import { defaultMockup } from './theme.js';
...
## Type
[DefaultMockupProps](https://github.com/themesberg/s-ui/blob/main/src/lib/types.ts#L620)
## Props
@prop children
