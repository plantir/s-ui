<script lang="ts">
	import { type CarouselProps, type CarouselContextType } from '../types.js';
	...
	const _state: CarouselContextType = $state({
		images: [],
		index: 0,
		forward: true,
		slideDuration: 500,
...
## Type
[CarouselProps](https://github.com/themesberg/s-ui/blob/main/src/lib/types.ts#L470)
## Props
@prop children
@prop slide
@prop images
