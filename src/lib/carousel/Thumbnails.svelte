<script lang="ts">
	import type { ThumbnailsProps } from '../types.js';
	import Thumbnail from './Thumbnail.svelte';
	import { getTheme } from '$lib/theme/themeUtils';
	import clsx from 'clsx';
	import { thumbnails } from './theme.js';
...
## Type
[ThumbnailsProps](https://github.com/themesberg/s-ui/blob/main/src/lib/types.ts#L506)
## Props
@prop children
@prop images = []
@prop index = $bindable()
