...
## Type
[IndicatorsProps](https://github.com/themesberg/s-ui/blob/main/src/lib/types.ts#L485)
## Props
@prop children
@prop activeClass
@prop inactiveClass
