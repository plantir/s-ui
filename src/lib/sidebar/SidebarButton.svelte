<script lang="ts">
	...
	import { sidebarButton } from './theme.js';
	import type { SidebarButtonProps } from '$lib/types.js';
...
## Type
[SidebarButtonProps](https://github.com/themesberg/s-ui/blob/main/src/lib/types.ts#L1472)
## Props
@prop breakpoint = "md"
