<script lang="ts">
	...
	let aCls = $derived(
		activeItem ? (activeClass ?? context.activeClass) : (nonActiveClass ?? context.nonActiveClass)
	);
</script>
...
## Type
[SidebarItemProps](https://github.com/themesberg/s-ui/blob/main/src/lib/types.ts#L1524)
## Props
@prop icon
@prop subtext
@prop href
