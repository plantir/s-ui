<script lang="ts">
	...
	import { sidebarBrand } from './theme.js';
	import type { SidebarBrandProps } from '$lib/types.js';
...
## Type
[SidebarBrandProps](https://github.com/themesberg/s-ui/blob/main/src/lib/types.ts#L1490)
## Props
@prop children
@prop site
@prop imgClass
