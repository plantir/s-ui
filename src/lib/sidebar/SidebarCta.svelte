<script lang="ts">
	...
	import { sidebarCta } from './theme.js';
	import type { SidebarCtaProps } from '$lib/types.js';
...
## Type
[SidebarCtaProps](https://github.com/themesberg/s-ui/blob/main/src/lib/types.ts#L1477)
## Props
@prop children
@prop icon
@prop divClass
