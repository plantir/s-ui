<script lang="ts">
	...
	import type { InputAddonProps } from '$lib/types.js';
	import { clampSize } from '$lib/input-field';
...
## Type
[InputAddonProps](https://github.com/themesberg/s-ui/blob/main/src/lib/types.ts#L891)
## Props
@prop children
