<script lang="ts">
	...
	import { navbarHamburger } from './theme.js';
	import type { NavHamburgerProps } from '$lib/types.js';
...
## Type
[NavHamburgerProps](https://github.com/themesberg/s-ui/blob/main/src/lib/types.ts#L1203)
## Props
@prop children
@prop onclick
@prop menuClass
