<script lang="ts">
	...
	import type { DrawerHandleProps } from '$lib/types.js';
	import clsx from 'clsx';
	import { drawerhandle } from './theme.js';
	...
	let { base, handle } = $derived(
		drawerhandle({ placement: placement ?? ctx?.placement ?? 'left' })
	);
</script>
