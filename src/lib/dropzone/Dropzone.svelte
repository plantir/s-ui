<script lang="ts">
	...
	import { dropzone } from './theme.js';
	import clsx from 'clsx';
	import type { DropzoneProps } from '$lib/types.js';
...
## Type
[DropzoneProps](https://github.com/themesberg/s-ui/blob/main/src/lib/types.ts#L802)
## Props
@prop children
