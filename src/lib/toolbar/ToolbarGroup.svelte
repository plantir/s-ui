<script lang="ts">
	...
	import type { ToolbarGroupProps } from '$lib/types.js';
	import clsx from 'clsx';
	import { getToolbarContext } from '$lib/context';
	import { toolbarGroup } from './theme.js';
...
## Type
[ToolbarGroupProps](https://github.com/themesberg/s-ui/blob/main/src/lib/types.ts#L1234)
## Props
@prop children
@prop spacing
@prop padding
