...
export type TestimonialPlaceholderVariants = VariantProps<typeof testimonialPlaceholder>;
...
export type WidgetPlaceholderVariants = VariantProps<typeof widgetPlaceholder>;
