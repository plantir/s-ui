<script lang="ts">
	import { testimonialPlaceholder } from './theme.js';
	import clsx from 'clsx';
	import type { TestimonialPlaceholderProps } from '$lib/types.js';
...
## Type
[TestimonialPlaceholderProps](https://github.com/themesberg/s-ui/blob/main/src/lib/types.ts#L1556)
## Props
