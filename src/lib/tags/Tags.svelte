<script lang="ts">
	...
	import type { TagsProps } from '$lib/types.js';
	import P from '$lib/paragraph/P.svelte';
	import CloseButton from '$lib/utils/CloseButton.svelte';
	import { tags } from './theme.js';
	...
	$effect(() => {
		...
		const shouldShow =
			availableTags.length > 0 && trimmed !== '' && inputContainer && dropdownElement;
...
## Type
[TagsProps](https://github.com/themesberg/s-ui/blob/main/src/lib/types.ts#L890)
## Props
@prop value = $bindable([])
