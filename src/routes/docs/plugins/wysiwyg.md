...
dir: components
description: Use the wysiwyg text editor component from s-ui-Plugins to create and modify content by manipulating paragraphs, headings, images and styling them using all available options
---
...
The WYSIWYG text editor from s-ui is open-source under the MIT license based on the Tip Tap library and allows you to easily edit complex text data with typography styles, links, images, videos, and more.

The markup and styles provided by s-ui are all built with the utility classes from Tailwind CSS and the styles for the content inside the WYSIWYG text editor are based on the Flowbite Typography plugin.
...
<P>See an example at <A href="https://s-ui-texteditor.vercel.app/examples/Toc" target="_blank">this page</A>.</P>
