<script lang="ts">
	...
	let placeholder: string = 'pnpm i -D s-ui flowbite';
...
<Input
	...
	{placeholder}
	readonly
	class="py-3 text-sm focus:border-primary-600 focus:ring-primary-600 sm:text-sm md:min-w-[315px] {className}"
>
	{#snippet right()}
		<div class="flex items-center ps-32">
			<button onclick={copyToClipboard} class="px-1 py-2 hover:text-primary-700">
