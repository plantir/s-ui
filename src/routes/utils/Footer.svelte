<script lang="ts">
	...
	const footer_links = {
		Resources: {
			GitHub: 'https://github.com/themesberg/s-ui',
		...
		'Help and Support': {
			...
			'GitHub Discussions': 'https://github.com/themesberg/s-ui/discussions'
		},
		Legal: {
			License: 'https://github.com/themesberg/s-ui/blob/main/LICENSE',
...
<Footer class="bg-white dark:bg-gray-900">
	<div class="mx-auto flex max-w-screen-xl flex-col py-6 lg:py-12">
		<div
			class="flex flex-col items-start gap-8 md:justify-between lg:flex-row {isHomePage
				? 'px-4 lg:px-4'
				: ''}"
		>
			<div class="w-full max-w-sm">
				...
				<p class="mt-4 mb-3 max-w-sm text-gray-600 dark:text-gray-400">
					Flowbite Svelte is an open-source UI component library built with Svelte components and
					Tailwind CSS that can help you build websites faster.
				</p>
				<p class="mb-3 max-w-sm text-gray-600 dark:text-gray-400">
					Code licensed
					<a
						href="https://github.com/themesberg/s-ui/blob/main/LICENSE"
						class="text-primary-600 hover:underline">MIT</a
					>
					, docs
					<a
						href="https://creativecommons.org/licenses/by/3.0/"
						class="text-primary-600 hover:underline">CC BY 3.0</a
					>
					.
				</p>
			</div>
			<div
				class="flex flex-col items-start md:flex-row {isHomePage
