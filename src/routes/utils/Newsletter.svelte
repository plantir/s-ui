...
<aside
	class="mb-8 flex flex-col items-start justify-center gap-4 rounded-base border bg-white p-4 shadow-lg sm:p-8 dark:border-gray-700 dark:bg-gray-800"
>
	<div class="flex flex-col items-center gap-5">
		<div class="flex flex-col items-start gap-4">
			<h4
				class="text-xl leading-none font-bold tracking-tight text-gray-900 sm:text-2xl dark:text-white"
			>
				Get more updates
			</h4>
			<p class="max-w-2xl">
					...
					<div class="flex w-full max-w-md items-center">
						...
						<ButtonGroup>
							<Input
								size="lg"
								id="member_email"
								class="ps-12 text-gray-900 focus:border-primary-600 focus:ring-primary-600 sm:w-96!"
								bind:value={email}
