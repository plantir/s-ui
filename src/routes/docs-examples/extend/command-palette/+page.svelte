...
<div class="min-h-screen bg-neutral-secondary-soft p-8">
	<div class="mx-auto max-w-4xl">
		...
		<p class="mb-8 text-body">
			Press <kbd class="rounded bg-neutral-tertiary px-2 py-1 font-mono text-sm"
				>⌘P (default ⌘K)</kbd
			>
			or
			<kbd class="rounded bg-neutral-tertiary px-2 py-1 font-mono text-sm"
				>Ctrl+P (default Ctrl+K)</kbd
			>
		...
		<button
			...
			class="mb-4 rounded-lg bg-brand px-6 py-3 font-medium text-white transition-colors hover:bg-brand-strong"
