...
<div id="clipboard-example" class="mx-auto max-w-7xl space-y-8 p-6">
	...
	<section class="space-y-6">
		...
		<div class="space-y-3 rounded-base p-6 shadow">
			<div class="flex items-center gap-3">
				<span class="rounded bg-green-100 px-2.5 py-0.5 text-xs font-semibold text-green-800"
					>Targeted</span
				>
				<Heading tag="h3" class="my-4 text-lg font-semibold">Target Specific Area</Heading>
			</div>
			<P class="text-sm">
				Limit selection menu to specific content area using CSS selector using <code
					class="font-bold text-primary-700">selectionTarget</code
				>
				prop.
			</P>
			<P class="text-sm">
				Use <code class="font-bold text-primary-700">enableSelectionMenu</code>
		...
		<div class="space-y-3 rounded-base p-6 shadow">
			...
			<P class="text-sm"
				>Display the clipboard manager in a modal dialog. Select any text in the paragraph to save
				it using the selection bubble menu.</P
			>
			<P class="text-sm">
				Set <code class="font-bold text-primary-700">storageKey</code>
		...
		<div class="space-y-3 rounded-base p-6 shadow">
			<div class="flex items-center gap-3">
				<span class="rounded bg-purple-100 px-2.5 py-0.5 text-xs font-semibold text-purple-800"
					>Documentation</span
				>
				<Heading tag="h3" class="text-lg font-semibold">Documentation Site</Heading>
			</div>
			<P class="text-sm"
				>Perfect for docs where users need to save commands, code snippets, or API examples</P
			>
			<P class="text-sm">
				Use <code class="font-bold text-primary-700">items</code>
				prop to set initial value. Use
				<code class="font-bold text-primary-700">limit</code>
		...
		<div class="space-y-3 rounded-base p-6 shadow">
			<div class="flex items-center gap-3">
				<span class="rounded bg-orange-100 px-2.5 py-0.5 text-xs font-semibold text-orange-800"
					>Content</span
				>
			...
			<P class="text-sm">
				Use <code class="font-bold text-primary-700">saveLabel</code>
				and
				<code class="font-bold text-primary-700">clearLabel</code>
				to change labels.
			</P>
			<ExampleWrapper
		...
		<div class="space-y-3 rounded-base p-6 shadow">
			...
			<P class="text-sm">
				...
				prop controls whether the clipboard items are saved to localStorage so they survive page refreshes
		...
		<div class="space-y-3 rounded-base p-6 shadow">
			<div class="flex items-center gap-3">
				<span class="rounded bg-indigo-100 px-2.5 py-0.5 text-xs font-semibold text-indigo-800"
					>Developer</span
				>
			...
			<P class="text-sm">
				...
				to unblock sensitive data such as password pattern, api token pattern, etc. The component provide
				default function (see below) to detect sensitive data. However use the
			...
			<List>
				<Li
					>Detects common sensitive information (credit cards, passwords, API keys, credentials).</Li
				>
				...
				<Li
					>Password regex is intentionally strict (12+ chars, mixed case, digits) and misses many
					real passwords</Li
				>
				<Li
					>API key regex matches any long alphanumeric token (32+ chars), which may catch legitimate
					IDs</Li
				>
		...
		<div class="space-y-3 rounded-base p-6 shadow">
			<div class="flex items-center gap-3">
				<span class="rounded bg-teal-100 px-2.5 py-0.5 text-xs font-semibold text-teal-800"
					>Advanced</span
				>
		...
		<div class="space-y-3 rounded-base p-6 shadow">
			<div class="flex items-center gap-3">
				<span class="rounded bg-neutral-tertiary px-2.5 py-0.5 text-xs font-semibold text-heading"
					>Custom</span
				>
