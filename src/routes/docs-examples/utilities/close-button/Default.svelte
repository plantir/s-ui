...
{#if visible}
  <div id="banner" tabindex="-1" class="border-default bg-neutral-secondary-soft z-50 flex w-full items-start justify-between gap-8 border px-4 py-3 sm:items-center lg:py-4">
