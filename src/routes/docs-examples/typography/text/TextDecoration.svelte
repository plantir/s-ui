...
<P>
  Track work across the enterprise through an open, collaborative platform. <Span underline class="decoration-indigo">Link issues across Jira</Span> and ingest data from other <Span underline>
