<script lang="ts">
	import { Label, ButtonGroup, Select, Clipboard, Tooltip, Helper, A } from "$lib/index";
...
<form class="mx-auto max-w-sm">
	<div class="mb-2 flex items-center justify-between">
		<Label for="phone-numbers" class="text-sm font-medium text-gray-900 dark:text-white"
	...
	<Helper id="helper-text-explanation" class="mt-2 text-sm"
		>Please set your primary phone number.</Helper
	>
</form>
