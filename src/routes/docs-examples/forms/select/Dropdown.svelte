<script lang="ts">
	import { Select, Button, ButtonGroup, Dropdown, DropdownItem } from "$lib/index";
...
<ButtonGroup class="w-full">
	<Button
		class="bg-neutral-secondary-medium text-body hover:bg-neutral-tertiary-medium hover:text-heading focus:ring-neutral-tertiary"
	>
		<Usa />
		USA
