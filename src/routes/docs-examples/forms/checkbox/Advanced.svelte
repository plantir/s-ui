...
<div class="grid w-full gap-6 md:grid-cols-3">
	<Checkbox custom>
		<div
			class="w-full cursor-pointer rounded-lg border-2 border-default bg-neutral-primary-soft p-5 font-normal text-body peer-checked:border-fg-brand peer-checked:text-heading hover:bg-neutral-primary-medium hover:text-heading"
		>
			<React />
