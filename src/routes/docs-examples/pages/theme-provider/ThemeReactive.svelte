		...
		<div>
			...
			<div class="flex flex-wrap gap-2">
				{#each colors as color}
					<button
						class="rounded px-4 py-2 capitalize transition-colors {selectedColor === color
		...
		<div>
			...
			<div class="flex gap-2">
				{#each widthOptions as width}
					<button
						class="rounded px-4 py-2 {buttonWidth === width
			...
			<div>
				...
				<Card class="p-6">
					...
					<p class="leading-tight font-normal text-gray-700 dark:text-gray-400">
						This card's background should change reactively when you select different color themes
						above. The button should also update its color and width based on your selections.
					</p>
					<p class="mt-4 text-sm text-gray-600">
						If you see the colors and sizes changing instantly, the ThemeProvider reactivity is
						working correctly! 🎉
					</p>
				</Card>
			</div>
