<script lang="ts">
	import { Button, Dropdown, DropdownItem, DropdownGroup, Avatar } from "$lib/index";
...
<Dropdown class="h-48 w-48 overflow-y-auto py-1">
	...
	<a
		href="/"
		class="-mb-1 flex items-center bg-neutral-tertiary px-3 py-2 text-sm font-medium text-fg-brand hover:bg-neutral-tertiary-medium hover:underline"
	>
