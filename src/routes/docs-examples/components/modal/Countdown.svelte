...
<div class="flex flex-col gap-4">
	...
	>
		...
		<P
			...
			and is meant to ensure a common set of data rights in the European Union.</P
		>

		{#snippet footer()}
			<Button value="success" onclick={() => alert('Clicked type is button')}
				>Button won't close the modal</Button
			>
