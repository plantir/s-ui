<script lang="ts">
	import { ProgressStepper, Button, P, Heading } from "$lib/index";
...
<Heading tag="h3" class="mb-2 text-lg font-semibold"
	>Example 1: Basic clickable progress stepper with numbers</Heading
>
...
<Heading tag="h3" class="mt-8 mb-2 text-lg font-semibold"
	>Example 3: Without checkmarks (shows numbers for all steps)</Heading
>
