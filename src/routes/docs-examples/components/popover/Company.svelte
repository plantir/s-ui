	...
	<div class="flex">
		<div class="me-3 shrink-0">
			<a href="/" class="block rounded bg-neutral-tertiary p-2">
				<img class="h-8 w-8 rounded-full" src="/images/s-ui-icon-logo.svg" alt="Flowbite logo" />
			</a>
		</div>
		<div>
			...
			<ul class="text-sm">
				<li class="mb-2 flex items-center">
					...
					<a href="/" class="text-fg-brand hover:underline">https://flowbite.com/</a>
				</li>
			...
			<div class="ms-4 mb-3 flex">
				...
				<Avatar
					stacked
					href="/"
					class="bg-neutral-tertiary-medium text-heading hover:bg-neutral-tertiary">+3</Avatar
				>
			</div>
			<div class="flex">
