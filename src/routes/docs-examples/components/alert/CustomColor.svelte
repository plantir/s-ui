...
<Alert
	border
	class="border-teal-300 bg-teal-50 text-teal-900 dark:border-teal-700 dark:bg-teal-900 dark:text-teal-100"
>
	{#snippet icon()}<InfoCircleSolid class="h-5 w-5" />{/snippet}
...
<Alert
	dismissable
	closeButtonProps={{ color: 'danger' }}
	class="bg-pink-100 text-pink-900 dark:bg-pink-900 dark:text-pink-100"
>
	{#snippet icon()}<InfoCircleSolid class="h-5 w-5" />{/snippet}
