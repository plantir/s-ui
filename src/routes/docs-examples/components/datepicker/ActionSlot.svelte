<script lang="ts">
	import { Datepicker, P, Button } from "$lib/index";
		...
		{#snippet actionSlot({ selectedDate, handleClear, handleApply })}
			<div class="mt-2 flex gap-2">
				...
				<Button
					...
					disabled={!selectedDate}>Apply</Button
				>
				<Button size="sm" onclick={() => console.log('Selection:', selectedDate || 'None')}
...
Lorem ipsum dolor sit amet consectetur adipisicing elit. In quidem rerum, optio adipisci illum at
earum fugiat eius minus quae! Quisquam cumque architecto facilis? Tempora ipsum perferendis quo
explicabo minus.
