...
<Table>
	<caption class="bg-neutral-primary-soft p-5 text-left text-lg font-semibold text-heading">
		Our products
		<p class="mt-1 text-sm font-normal text-body">
	...
	<TableBody>
		<TableBodyRow>
			...
			<TableBodyCell>
				<a href="/tables" class="font-medium text-fg-brand hover:underline">Edit</a>
			</TableBodyCell>
		</TableBodyRow>
		<TableBodyRow>
