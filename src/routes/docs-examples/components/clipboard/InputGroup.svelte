<script lang="ts">
	import { Clipboard, Label, Input, InputAddon, Tooltip, ButtonGroup, Helper } from "$lib/index";
...
<div class="space-y-2">
	...
	<Helper class="mt-2 text-sm text-body">Security certificate is required for approval</Helper>
</div>
