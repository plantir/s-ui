<script lang="ts">
	import { Card, Clipboard, Input, Label, Tooltip, Button } from "$lib/index";
	...
	<form class="flex flex-col space-y-6" action="/">
		...
		<p class="mb-6 text-body">
			To give Flowbite read access, please create an IAM Role following <a
				href="#top"
				class="font-medium text-fg-brand underline hover:no-underline">trust relationship</a
			>
			and
			<a href="#top" class="font-medium text-fg-brand underline hover:no-underline">inline policy</a
			>
			.
		</p>
