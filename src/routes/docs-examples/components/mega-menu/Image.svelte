<script lang="ts">
	import { Navbar, NavBrand, NavHamburger, NavUl, NavLi, MegaMenu, Button } from "$lib/index";
...
<Navbar>
	...
	<NavUl>
		...
		<NavLi class="cursor-pointer">
			Mega menu<ChevronDownOutline class="ms-2 inline h-6 w-6 text-fg-brand" />
		</NavLi>
		<MegaMenu full items={menu}>
			...
			{#snippet addon()}
				...
				>
					<p
						class="mb-5 max-w-xl p-0 text-sm leading-tight font-extrabold tracking-tight text-white"
					>
