...
<div class="relative min-h-screen p-8">
	<div class="z-50 space-y-3" style="position: absolute; top: 1rem; right: 1rem;">
		{#each toasts as toast (toast.id)}
			<Toast
				...
				dismissable={true}
				transition={fly}
				transitionParams={{ x: 400, duration: 300 }}
				class="w-64"
	...
	<div class="mx-auto max-w-2xl">
		<div class="rounded-xl p-8 shadow-lg">
			...
			<P class="mb-8"
				>Click the buttons below to trigger toast notifications. Each toast will appear in the
				top-right corner and automatically dismiss after 5 seconds.</P
			>
			<div class="space-y-4">
